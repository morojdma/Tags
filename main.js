...
const inpuTagContainer = document.querySelector('#input-tag');
const tagsContainer = document.createElement('div');
const inputTag = document.createElement('span');

inputTag.ariaRoleDescription ='textbox';
inputTag.contentEditable = "true";
inputTag.classList = ("input");
inputTag.focus();

inpuTagContainer.classList.add("input-tag-container");
tagsContainer.classList.add("tag-container");


inpuTagContainer.appendChild(tagsContainer);
tagsContainer.appendChild(inputTag);


inpuTagContainer.addEventListener('click', e=>{
    if(
